/*Реализовать сетевую игру со следующими правилами. Игра ведется между двумя
игроками. В ящике лежат 6 черных и 2 белых шара. На первом ходу игры первый и
второй игроки достают по шару, если у обоих оказались белые шары, результатом игры
считается ничья и игра завершается, если только у одного шар белый, такой игрок
объявляется победителем и игра завершается, если у обоих шары черные начинается
следующий аналогичный ход игры. В клиентах отображать не только
окончательный результат игры, но и состояния игрока и его оппонента на
каждом ходе игры.*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
